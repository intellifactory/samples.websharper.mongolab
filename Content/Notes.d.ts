            ...
            module Controls {
                var input : {
                    <_M1>(type: string, ofString: {
                        ...
                        (x: _M1): string;
                    }, stream: __ABBREV.__Piglets.Stream<_M1>): __ABBREV.__Client.Element;
                };
                var WithLabel : {
                    (label: string, element: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var WithLabelAfter : {
                    (label: string, element: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var IntInput : {
                    (stream: __ABBREV.__Piglets.Stream<number>): __ABBREV.__Client.Element;
                };
                var TextArea : {
                    (stream: __ABBREV.__Piglets.Stream<string>): __ABBREV.__Client.Element;
                };
                var CheckBox : {
                    (stream: __ABBREV.__Piglets.Stream<boolean>): __ABBREV.__Client.Element;
                };
                var Radio : {
                    <_M1>(stream: __ABBREV.__Piglets.Stream<_M1>, values: __ABBREV.__WebSharper.seq<any>): __ABBREV.__Client.Element;
                };
                var Select : {
                    <_M1>(stream: __ABBREV.__Piglets.Stream<_M1>, values: __ABBREV.__WebSharper.seq<any>): __ABBREV.__Client.Element;
                };
                var RenderMany : {
                    <_M1, _M2, _M3, _M4>(stream: __ABBREV.__Many.Stream<_M1, _M2, __ABBREV.__Client.Element, _M3, _M4>, renderOne: {
                        (x: __ABBREV.__Many.Operations): _M2;
                    }, container: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var RenderChoice : {
                    <_M1, _M2, _M3, _M4, _M5>(stream: __ABBREV.__Choose.Stream<_M1, _M2, _M3, _M4, _M5, __ABBREV.__Client.Element>, renderOne: _M5, container: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var ShowResult : {
                ...
                var EnableOnSuccess : {
                    <_M1>(reader: __ABBREV.__Piglets.Reader<_M1>, element: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var Submit : {
                    (submit: __ABBREV.__Piglets.Writer<void>): __ABBREV.__Client.Element;
                };
                var SubmitValidate : {
                    <_M1>(submit: __ABBREV.__Piglets.Submitter<_M1>): __ABBREV.__Client.Element;
                };
                var Button : {
                    (submit: __ABBREV.__Piglets.Writer<void>): __ABBREV.__Client.Element;
                };
                ...
                var Attr : {
                    <_M1>(reader: __ABBREV.__Piglets.Reader<_M1>, attrName: string, render: {
                        (x: _M1): string;
                    }, element: __ABBREV.__Client.Element): __ABBREV.__Client.Element;
                };
                var AttrResult : {
                    <_M1>(reader: __ABBREV.__Piglets.Reader<_M1>, attrName: string, render: {
...
declare module IntelliFactory {
    module WebSharper {
        module MongoLab {
            module Functions {
                var op_GreaterMinus : {
                    <_M1>(database: __ABBREV.__Types.Database, collection: __ABBREV.__Types.Collection<_M1>): __ABBREV.__Types.PushableCollection<_M1>;
                };
                var Where : {
                    <_M1>(constraint: {
                        (): __ABBREV.__Types.Constraint;
                    }, collection: __ABBREV.__Types.Collection<_M1>): __ABBREV.__Types.Collection<_M1>;
                };
                var Sort : {
                    <_M1>(sorts: __ABBREV.__List.T<any>, collection: __ABBREV.__Types.Collection<_M1>): __ABBREV.__Types.Collection<_M1>;
                };
                var Fetch : {
                    <_M1>(collection: __ABBREV.__Types.Collection<_M1>): any;
                };
                var Count : {
                    <_M1>(collection: __ABBREV.__Types.Collection<_M1>): any;
                };
                var Push : {
                    <_M1>(data: _M1, collection: __ABBREV.__Types.PushableCollection<_M1>): any;
                };
            }
            module Types {
                module Constraint {
                    var get_ToString : {
                        (): {
                            (x: __ABBREV.__WebSharper.OptionProxy<__ABBREV.__Types.Constraint>): string;
                        };
                    };
                }
                module Condition {
                    var ToString : {
                        (fieldName: string, condition: __ABBREV.__Types.Condition): string;
                    };
                }
                module Collection {
                    var ToString : {
                        <_M1>(collection: __ABBREV.__Types.Collection<_M1>): string;
                    };
                }
                interface Database {
                    get_Name(): string;
                }
                interface Collection<_T1> {
                    get_Name(): string;
                    get_Database(): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__Types.Database>;
                    set_Database(v: __ABBREV.__WebSharper.OptionProxy<__ABBREV.__Types.Database>): void;
                    get_Constraint(): __ABBREV.__WebSharper.OptionProxy<__ABBREV.__Types.Constraint>;
                    set_Constraint(v: __ABBREV.__WebSharper.OptionProxy<__ABBREV.__Types.Constraint>): void;
                    get_Sorts(): __ABBREV.__List.T<any>;
                    set_Sorts(v: __ABBREV.__List.T<any>): void;
                }
                interface PushableCollection<_T1> {
                }
            ...
            module Variables {
                var BaseUrl : {
                    (): __ABBREV.__WebSharper.ref<string>;
                };
                var Key : {
                    (): __ABBREV.__WebSharper.ref<string>;
                };
...
declare module __ABBREV {
    ...
    export import __Types = IntelliFactory.WebSharper.MongoLab.Types;
    export import __List = IntelliFactory.WebSharper.List;
    export import __WebSharper = IntelliFactory.WebSharper;
}
