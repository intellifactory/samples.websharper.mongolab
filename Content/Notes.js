...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Concurrency,jQuery,MongoLab,Variables,Types,Collection,JSON,PushableCollection,List,T,Constraint,Condition;
 Runtime.Define(Global,{
  WebSharper:{
   MongoLab:{
    Functions:{
     Count:function(collection)
     {
      return Concurrency.FromContinuations(function(tupledArg)
      {
       var ok;
       ok=tupledArg[0];
       jQuery.getJSON((Variables.BaseUrl())[0]+Collection.ToString(collection)+"&c=true&apiKey="+(Variables.Key())[0],null,function(result)
       {
        return ok(result);
       });
       return;
     ...
     Fetch:function(collection)
     {
      return Concurrency.FromContinuations(function(tupledArg)
      {
       var ok;
       ok=tupledArg[0];
       jQuery.getJSON((Variables.BaseUrl())[0]+Collection.ToString(collection)+"&apiKey="+(Variables.Key())[0],null,function(result)
       {
        return ok(result);
       });
       return;
     ...
     Push:function(data,collection)
     {
      return Concurrency.FromContinuations(function(tupledArg)
      {
       var ok;
       ok=tupledArg[0];
       jQuery.ajax((Variables.BaseUrl())[0]+Collection.ToString(collection)+"&apiKey="+(Variables.Key())[0],{
        type:"POST",
        data:JSON.stringify(data),
        success:Runtime.CreateFuncWithArgs(function()
        {
         return ok(true);
        }),
        headers:{
 ...
 Runtime.OnInit(function()
 {
  Concurrency=Runtime.Safe(Global.WebSharper.Concurrency);
  jQuery=Runtime.Safe(Global.jQuery);
  MongoLab=Runtime.Safe(Global.WebSharper.MongoLab);
...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,MongoLab,Variables,document,Html,Client,Operators,List,Attr,Tags,jQuery,EventsPervasives,Concurrency,Functions,Types,Database,Collection,alert,Notes,Client1,Piglets,Piglet,Pervasives,Date,Controls,Arrays,String;
 Runtime.Define(Global,{
  Notes:{
   Client:{
    Main:Runtime.Field(function()
    {
     var arg10,arg101,arg102,arg103,x,arg00,arg104,action,_arg10_,x1,arg109,arg10a;
     (Variables.Key())[0]="pS_nPkhL6Co1H2sLRuovMj7rz5XEVMMF";
     arg10=List.ofArray([Attr.Attr().NewAttr("id","wrapper")]);
     arg101=List.ofArray([Attr.Attr().NewAttr("id","header")]);
     arg102=List.ofArray([Tags.Tags().text("Notes")]);
     arg103=List.ofArray([Tags.Tags().text("+ New")]);
     x=Tags.Tags().NewTag("button",arg103);
     arg00=function()
     {
      return function()
      {
     ...
     EventsPervasives.Events().OnClick(arg00,x);
     arg104=List.ofArray([Attr.Attr().NewAttr("class","fix")]);
     action=function(note)
     {
      return Concurrency.Start(Concurrency.Delay(function()
      {
       return Concurrency.Bind(Functions.Push(note,Functions.op_GreaterMinus(Database.New("websharper"),Collection.New("Notes"))),function(_arg1)
       {
        if(_arg1)
         {
          alert("Saved!");
     ...
     _arg10_=Piglet.WithSubmit(Pervasives.op_LessMultiplyGreater(Pervasives.op_LessMultiplyGreater(Piglet.Return(function(title)
     {
     ...
     x1=Piglet.Run(action,_arg10_);
     arg109=List.ofArray([Attr.Attr().NewAttr("id","notes")]);
     arg10a=List.ofArray([Attr.Attr().NewAttr("src","loading.gif")]);
     document.body.appendChild(Operators.add(Tags.Tags().NewTag("div",arg10),List.ofArray([Operators.add(Tags.Tags().NewTag("div",arg101),List.ofArray([Tags.Tags().NewTag("h1",arg102),x,Tags.Tags().NewTag("div",arg104)])),Piglet.Render(function(x2)
     {
      return function(y)
      {
       return function(z)
       {
        var arg105,arg106,arg107,arg108;
        arg105=List.ofArray([Attr.Attr().NewAttr("id","form")]);
        arg106=List.ofArray([Attr.Attr().NewAttr("class","container")]);
        arg107=List.ofArray([Tags.Tags().text("Title")]);
        arg108=List.ofArray([Operators.add(Controls.Submit(z),List.ofArray([Attr.Attr().NewAttr("value","Save")]))]);
        return Operators.add(Tags.Tags().NewTag("div",arg105),List.ofArray([Operators.add(Tags.Tags().NewTag("div",arg106),List.ofArray([Tags.Tags().NewTag("label",arg107),Controls.input("text",function(x3)
        {
         return x3;
        },function(x3)
        {
         return x3;
        },x2),Operators.add(Controls.TextArea(y),List.ofArray([Attr.Attr().NewAttr("rows","4")])),Tags.Tags().NewTag("div",arg108)]))]));
       };
      };
     },x1),Operators.add(Tags.Tags().NewTag("div",arg109),List.ofArray([Tags.Tags().NewTag("img",arg10a)]))])).get_Body());
    ...
    loadNotes:function()
    {
     return Concurrency.Start(Concurrency.Delay(function()
     {
      ...
      {
       var x2,arg104,x6,wrapper;
       x2=Arrays.map(function(note)
       {
        var date,arg10,arg101,x3,arg102,x4,copyOfStruct,copyOfStruct1,arg103,x5;
        date=new Date(note.Date);
        arg10=List.ofArray([Attr.Attr().NewAttr("class","note")]);
        x3=note.Title;
        arg101=List.ofArray([Tags.Tags().text(x3)]);
        copyOfStruct=date.getDate();
        copyOfStruct1=date.getFullYear();
        x4=Client1.months().get_Item(date.getMonth())+" "+String(copyOfStruct)+", "+String(copyOfStruct1);
        arg102=List.ofArray([Tags.Tags().text(x4)]);
        x5=note.Text;
        arg103=List.ofArray([Tags.Tags().text(x5)]);
        return Operators.add(Tags.Tags().NewTag("div",arg10),List.ofArray([Tags.Tags().NewTag("h2",arg101),Tags.Tags().NewTag("span",arg102),Tags.Tags().NewTag("p",arg103)]));
       },_arg1);
       arg104=List.ofArray([Attr.Attr().NewAttr("id","notes")]);
       x6=Operators.add(Tags.Tags().NewTag("div",arg104),x2);
       wrapper=document.getElementById("wrapper");
       wrapper.replaceChild(x6.get_Body(),wrapper.lastChild);
       return Concurrency.Return(null);
      });
     }),{
      $:0
